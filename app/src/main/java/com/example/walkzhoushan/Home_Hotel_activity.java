...
public class Home_Hotel_activity extends AppCompatActivity {
    ...
    protected void goToLink() {
        layout_base_web = (LinearLayout) findViewById(R.id.layout_hotel_web);
...
//                });
        ...
        mAgentWeb = preAgentWeb.go("https://m.dianping.com/awp/h5/hotel-dp/list/list.html?cityid=107&from=m_nav_3_jiudian"); //url
    }
